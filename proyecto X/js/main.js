...
function showHelp() {
    ...
    $("#inst_main_body").html("<div id = 'instructions_head'>COMO JUGAR</div><p>El objetivo de HEXAPOP es evitar que los bloques salgan del interior del hexágono gris exterior..</p><p>" + (settings.platform != 'mobile' ? 'Presione las teclas de flecha derecha e izquierda' : 'Toque el lado izquierdo o derecho de la pantalla') + " para rotar el Hexágono." + (settings.platform != 'mobile' ? ' Presione la flecha hacia abajo para acelerar la caída del bloque' : '') + " </p><p>Limpia bloques y obtén puntos haciendo que 3 o más bloques del mismo color se toquen.</p><p>El tiempo restante antes de que tu racha de combos desaparezca se indica mediante <span style='color:#FFC0CB;'>el numero</span> <span style='color:#7A288A'>de lineas</span> <span style='color:#0097A7'>de colores</span> <span style='color:#2ecc71'>en el</span> hexágono exterior </p>");
    if (gameState == 1) {
        pause();
    }
